...
class _HotelTabState extends State<HotelTab> {
  ...
  Widget _buildItem(int index) {
    ...
    FirebaseFirestore.instance.collection('ratingdj');
    ...
    void _wishlistHotel(String hotelId, BuildContext context) async {
      ...
      await FirebaseFirestore.instance.collection('wishlistevents').add({
        'email': email,
        'name': snapshot['name'],
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text('Event added to wishlist!'),
